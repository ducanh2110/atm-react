...
//>>>>>>> e5a0ec732aade688f2909f888ba5bdeb9049fbd8
	...
	@Override
	public Account editAcc(AccountRequest request) throws ATMException {
		Account account = Optional.ofNullable(repository.findById(request.getId())).orElse(new Account());
		account.setAccountNumber(request.getAccountNumber());
		account.setUsername(request.getUsername());
		account.setPassword(PasswordEncryption.toMD5(request.getPassword()));
